...
// add the QPY 2040 file 
#include "adafruit_qtpy_rp2040.h"
//define the button of pin on RP2040
...
int main() {
    ...
    sleep_ms(1000);
    //capture into a u32 buffer, make the number of pins being sampled isn't a simple a power of 2
    ...
    while(1) {
        printf("press booot to for arming trigger\n");
